  ...
  try {
    ...
    for (const feature of geojson.features) {
      ...
      if (feature.geometry.type === 'Polygon' || feature.geometry.type === 'MultiPolygon') {
        ...
        // Optional: Grab the name if OSM provides it, otherwise call it 'Unnamed Industrial Zone'
        const name = feature.properties?.name || 'Unnamed Industrial Zone';
    ...
    console.log(`✅ Successfully seeded ${successCount} real industrial zones into PostGIS!`);
